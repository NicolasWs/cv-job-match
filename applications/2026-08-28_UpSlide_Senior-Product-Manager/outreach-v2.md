# Outreach v1 — UpSlide, Senior Product Manager
...
**Subject:** Senior Product Manager (Refine) — AI-native shipper with a decade in finance decks/models

Hi Matteo,

I saw the Senior Product Manager opening on the Refine team and wanted to reach out directly. The role sits exactly at the intersection I've built my career around: financial deliverables (PowerPoint, Excel) and, most recently, shipping AI-native product end-to-end — a broker-voting app I took from design to production in under two months this year using a full AI SDLC.

Before that: five years running discovery and demo delivery for 30+ investment banks and asset managers at Finastra, and leading the SaaS onboarding of HSBC GAM at Opensee. I've attached my CV — happy to walk through how I'd approach the agent-library roadmap and the eval/QA loop specifically.
...
Hi Matteo — following UpSlide's Refine team with real interest: AI agents for finance decks/models is exactly where my last decade (Sophis, FusionRisk, Opensee) plus this year's AI-native shipping experience converge. Applied for the Senior PM role — would love to connect.
